...
export function Nav({ currentTab, onTabChange }: NavProps) {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white grid grid-cols-3 py-3 sm:py-2.5 pb-[max(12px,env(safe-area-inset-bottom))] border-t border-gray-200 shadow-lg touch-manipulation">
      <button
